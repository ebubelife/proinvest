...
<button type="button" style="width:100%"  class="btn btn-info shadow-xl">Withdraw</button>

<button type="button" style="width:100%"  class="btn btn-primary shadow-xl mt-2">View Withdrawal History</button>
